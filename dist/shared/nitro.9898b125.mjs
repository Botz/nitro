...
import { isValidNodeImport, normalizeid, resolvePath as resolvePath$1, sanitizeFilePath, resolvePathSync, resolveModuleExportNames } from 'mlly';
...
import { n as name, v as version } from './nitro.4f804c0e.mjs';
