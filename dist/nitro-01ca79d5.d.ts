...
declare namespace _PRESETS {
  export {
    ...
    _PRESETS_cloudflarePagesStatic as cloudflarePagesStatic,
...
export { $Fetch as $, AvailableRouterMethod as A, CompressOptions as C, DevServerOptions as D, ExtractedRouteMethod as E, InternalApi as I, KebabCase as K, MiddlewareOf as M, NitroRuntimeHooks as N, PrerenderRoute as P, ResponseCacheEntry as R, StorageMounts as S, TypedInternalResponse as T, Nitro as a, NitroConfig as b, NitroOptions as c, NitroEventHandler as d, NitroPreset as e, NitroFetchRequest as f, NitroFetchOptions as g, NitroDynamicConfig as h, NitroRuntimeConfig as i, PrerenderGenerateRoute as j, NitroHooks as k, AppConfig as l, PublicAssetDir as m, ServerAssetDir as n, NitroRouteConfig as o, NitroRouteRules as p, NitroDevEventHandler as q, NitroErrorHandler as r, MatchedRoutes as s, CacheEntry as t, CacheOptions as u, CachedEventHandlerOptions as v, RenderResponse as w, RenderHandler as x };
